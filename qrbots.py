...
WELCOME_MESSAGE = (
    ...
    "✨ Usa el comando /qrbot para comenzar a leer códigos QR (por ejemplo, de Nequi o Bancolombia).\n"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        WELCOME_MESSAGE.format(user_id=user_id, username=username)
    )

# Comando /qrbot (verifica autorización y pide la imagen)
async def qrbot(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
def main():
    ...
    application.add_handler(CommandHandler("qrbot", qrbot))
